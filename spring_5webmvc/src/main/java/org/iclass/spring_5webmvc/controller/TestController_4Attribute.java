...
public class TestController_4Attribute {
    // 생성자 자동 주입 : 생성자에서 같은 타입의 bean을 가져와 초기화
    // ㄴ @AllArgsConstructor 붙여줌
    private CustomerMapper customerMapper;


    @GetMapping("/customer/list")
    public String list(Model model) { // 메소드 인자인 Model 타입 bean 자동주입됩니다.
    ...
    public String getMethodName(Model model) {
        ...
        // 애트리뷰트 page, dto, list 는 저장 안하고 테스트
