...
public class CustomerMapperTest {
    ...
    @Test
    void update() {
        int result = customerMapper.update(CustomerDto.builder()
                .customerId("JJangu2")
                .age(24)
                .email("jj@naver.com")
                .build());
        log.info("{}", customerMapper.selectByPk("JJangu2"));
        assertEquals(1, result);
    }

    @Test
    void remove() {
        int result = customerMapper.delete("JJangu2");
        assertEquals(1, result);
        assertNull(customerMapper.selectByPk("JJangu2"));
    }
